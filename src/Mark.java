 ...
 */
public class Mark {
    public static VertexArray2 object;

    private Vector3f color;

    public Matrix4f theObject = Matrix4f.identity();
...
//        this.scale(new Vector3f(distanceDivider, distanceDivider, distanceDivider));
        theObject = (Matrix4f.translate(pos)).multiply(Matrix4f.scale(new Vector3f(0.15f, 0.15f, 0.15f)));
    }
